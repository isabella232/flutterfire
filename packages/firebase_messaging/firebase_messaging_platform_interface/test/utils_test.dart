...
void main() {
  ...
  group('Utilities', () {
    ...
    test('convertFromNotificationPriority()', () {
      expect(convertFromNotificationPriority(NotificationPriority.high), isA<int>());
    });
    ...
    test('convertFromNotificationVisibility()', () {
      expect(convertFromNotificationVisibility(NotificationVisibility.public), isA<int>());
    });
