...
void main() {
  ...
  group('$AndroidNotification', () {
    ...
    test('toMap()', () {
      ...
      final notification = AndroidNotification(channelId: testChannelId, priority: NotificationPriority.low);
      final notificationMap = notification.toMap();
      expect(notificationMap, isA<Map<String, dynamic>>());
  ...
  group('$NotificationIOSCriticalSound', () {
    ...
    test('toMap()', () {
      ...
      final iosCriticalSound = new NotificationIOSCriticalSound(critical: testCritical);
